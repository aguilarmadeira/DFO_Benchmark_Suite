...
%   x2   ∈ [-40000      , 12000       ]   (range: 52000       )
%   x3   ∈ [-4          , 1.2         ]   (range: 5.2         )
%   x4   ∈ [-400        , 120         ]   (range: 520         )
%   x5   ∈ [-40000      , 12000       ]   (range: 52000       )
%   x6   ∈ [-4          , 1.2         ]   (range: 5.2         )
%   x7   ∈ [-400        , 120         ]   (range: 520         )
%   x8   ∈ [-40000      , 12000       ]   (range: 52000       )
%   x9   ∈ [-4          , 1.2         ]   (range: 5.2         )
%   x10  ∈ [-400        , 120         ]   (range: 520         )
%
...
lb_work = [-400;-40000;-4;-400;-40000;-4;-400;-40000;-4;-400];
ub_work = [120;12000;1.2;120;12000;1.2;120;12000;1.2;120];
