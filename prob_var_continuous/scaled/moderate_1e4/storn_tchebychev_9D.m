...
%   x2   ∈ [-12800      , 3840        ]   (range: 16640       )
%   x3   ∈ [-1.28       , 0.384       ]   (range: 1.664       )
%   x4   ∈ [-128        , 38.4        ]   (range: 166.4       )
%   x5   ∈ [-12800      , 3840        ]   (range: 16640       )
%   x6   ∈ [-1.28       , 0.384       ]   (range: 1.664       )
%   x7   ∈ [-128        , 38.4        ]   (range: 166.4       )
%   x8   ∈ [-12800      , 3840        ]   (range: 16640       )
%   x9   ∈ [-1.28       , 0.384       ]   (range: 1.664       )
%
...
lb_work = [-128;-12800;-1.28;-128;-12800;-1.28;-128;-12800;-1.28];
ub_work = [38.40000000000001;3840;0.3840000000000001;38.40000000000001;3840;0.3840000000000001;38.40000000000001;3840;0.3840000000000001];
scale_factors = [1;100;0.01;1;100;0.01;1;100;0.01];
