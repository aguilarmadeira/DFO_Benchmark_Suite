...
%   x2   ∈ [0           , 27.3        ]   (range: 27.3        )
%   x3   ∈ [0           , 0.00273     ]   (range: 0.00273     )
%   x4   ∈ [0           , 0.273       ]   (range: 0.273       )
%
% Effective contrast ratio (max range / min range): 10000
%
% Known global minimum (WORK-space):
%   x* = [0.192;19;0.00123;0.135]
%   f* = 0.00030748
%
% USAGE:
...
lb_work = [0;0;0;0];
ub_work = [0.273;27.3;0.00273;0.273];
scale_factors = [1;100;0.01;1];
...
if nargin == 0
    ...
    info.x_global_min_work = [0.192;19;0.00123;0.135];
