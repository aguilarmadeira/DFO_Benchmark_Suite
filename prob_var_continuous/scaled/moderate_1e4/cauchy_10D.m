...
%   x2   ∈ [200         , 1760        ]   (range: 1560        )
%   x3   ∈ [0.02        , 0.176       ]   (range: 0.156       )
%   x4   ∈ [2           , 17.6        ]   (range: 15.6        )
%   x5   ∈ [200         , 1760        ]   (range: 1560        )
%   x6   ∈ [0.02        , 0.176       ]   (range: 0.156       )
%   x7   ∈ [2           , 17.6        ]   (range: 15.6        )
%   x8   ∈ [200         , 1760        ]   (range: 1560        )
%   x9   ∈ [0.02        , 0.176       ]   (range: 0.156       )
%   x10  ∈ [2           , 17.6        ]   (range: 15.6        )
%
...
lb_work = [2;200;0.01999999999999999;2;200;0.01999999999999999;2;200;0.01999999999999999;2];
ub_work = [17.6;1760;0.176;17.6;1760;0.176;17.6;1760;0.176;17.6];
