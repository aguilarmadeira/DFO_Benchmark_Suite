...
%   x3   ∈ [-0.3        , 0.09        ]   (range: 0.39        )
%   x4   ∈ [-30         , 9           ]   (range: 39          )
%   x5   ∈ [-3000       , 900         ]   (range: 3900        )
%   x6   ∈ [-0.3        , 0.09        ]   (range: 0.39        )
%   x7   ∈ [-30         , 9           ]   (range: 39          )
%   x8   ∈ [-3000       , 900         ]   (range: 3900        )
%   x9   ∈ [-0.3        , 0.09        ]   (range: 0.39        )
%   x10  ∈ [-30         , 9           ]   (range: 39          )
%
% Effective contrast ratio (max range / min range): 10000
%
% Known global minimum (WORK-space):
%   x* = [0;0;5.551115123125783e-17;0;0;5.551115123125783e-17;0;0;5.551115123125783e-17;0]
%   f* = 0
%
% USAGE:
...
lb_work = [-30;-3000;-0.3;-30;-3000;-0.3;-30;-3000;-0.3;-30];
ub_work = [9;900;0.09000000000000001;9;900;0.09000000000000001;9;900;0.09000000000000001;9];
...
if nargin == 0
    ...
    info.x_global_min_work = [0;0;5.551115123125783e-17;0;0;5.551115123125783e-17;0;0;5.551115123125783e-17;0];
