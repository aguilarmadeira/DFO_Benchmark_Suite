...
%   x3   ∈ [-0.1        , 0.03        ]   (range: 0.13        )
%   x4   ∈ [-10         , 3           ]   (range: 13          )
%   x5   ∈ [-1000       , 300         ]   (range: 1300        )
%   x6   ∈ [-0.1        , 0.03        ]   (range: 0.13        )
%   x7   ∈ [-10         , 3           ]   (range: 13          )
%   x8   ∈ [-1000       , 300         ]   (range: 1300        )
%   x9   ∈ [-0.1        , 0.03        ]   (range: 0.13        )
%   x10  ∈ [-10         , 3           ]   (range: 13          )
%
% Effective contrast ratio (max range / min range): 10000
%
% Known global minimum (WORK-space):
%   x* = [1;100;0.009999999999999995;1;100;0.009999999999999995;1;100;0.009999999999999995;1]
%   f* = 0
%
% USAGE:
...
lb_work = [-10;-1000;-0.1;-10;-1000;-0.1;-10;-1000;-0.1;-10];
ub_work = [3;300;0.03;3;300;0.03;3;300;0.03;3];
...
if nargin == 0
    ...
    info.x_global_min_work = [1;100;0.009999999999999995;1;100;0.009999999999999995;1;100;0.009999999999999995;1];
