...
%
%   x1   ∈ [-100        , 30          ]   (range: 130         )
%   x2   ∈ [-10000      , 3000        ]   (range: 13000       )
%   x3   ∈ [-1          , 0.3         ]   (range: 1.3         )
%   x4   ∈ [-100        , 30          ]   (range: 130         )
%   x5   ∈ [-10000      , 3000        ]   (range: 13000       )
%   x6   ∈ [-1          , 0.3         ]   (range: 1.3         )
%   x7   ∈ [-100        , 30          ]   (range: 130         )
%   x8   ∈ [-10000      , 3000        ]   (range: 13000       )
%   x9   ∈ [-1          , 0.3         ]   (range: 1.3         )
%   x10  ∈ [-100        , 30          ]   (range: 130         )
%
% Effective contrast ratio (max range / min range): 10000
%
% Known global minimum (WORK-space):
%   x* = [10;1800;0.2400000000000002;28;3000;0.3;28;2400;0.1799999999999999;10]
%   f* = -210
%
% USAGE:
...
lb_work = [-100;-10000;-1;-100;-10000;-1;-100;-10000;-1;-100];
ub_work = [30;3000;0.3;30;3000;0.3;30;3000;0.3;30];
...
if nargin == 0
    ...
    info.x_global_min_work = [10;1800;0.2400000000000002;28;3000;0.3;28;2400;0.1799999999999999;10];
