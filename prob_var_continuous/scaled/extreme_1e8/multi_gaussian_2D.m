...
%
%   x1   ∈ [-2          , 0.6         ]   (range: 2.6         )
%   x2   ∈ [-200000000  , 60000000    ]   (range: 260000000   )
%
% Effective contrast ratio (max range / min range): 100000000
%
% Known global minimum (WORK-space):
%   x* = [-0.01356000000000002;-1356000.00000003]
%   f* = -1.29695
%
% USAGE:
...
lb_work = [-2;-200000000];
ub_work = [0.6000000000000001;60000000];
...
if nargin == 0
    ...
    info.x_global_min_work = [-0.01356000000000002;-1356000.00000003];
