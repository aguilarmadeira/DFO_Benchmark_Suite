...
%   x2   ∈ [-512000000  , 153600000   ]   (range: 665600000   )
%   x3   ∈ [-512000000  , 153600000   ]   (range: 665600000   )
%
% Effective contrast ratio (max range / min range): 100000000
%
% Known global minimum (WORK-space):
%   x* = [0;-5.960464477539062e-08;-5.960464477539062e-08]
%   f* = 0
%
% USAGE:
...
lb_work = [-5.12;-512000000;-512000000];
ub_work = [1.536;153600000;153600000];
...
if nargin == 0
    ...
    info.x_global_min_work = [0;-5.960464477539062e-08;-5.960464477539062e-08];
