...
%   x1   ∈ [-1          , 0.3         ]   (range: 1.3         )
%   x2   ∈ [-1          , 0.3         ]   (range: 1.3         )
%   x3   ∈ [-100000000  , 30000000    ]   (range: 130000000   )
%   x4   ∈ [-100000000  , 30000000    ]   (range: 130000000   )
%
% Effective contrast ratio (max range / min range): 100000000
%
% Known global minimum (WORK-space):
%   x* = [0;0;-1.490116119384766e-08;-1.490116119384766e-08]
%   f* = -1
%
% USAGE:
...
lb_work = [-1;-1;-100000000;-100000000];
ub_work = [0.3;0.3;30000000;30000000];
...
if nargin == 0
    ...
    info.x_global_min_work = [0;0;-1.490116119384766e-08;-1.490116119384766e-08];
