...
%   x4   ∈ [-10         , 3           ]   (range: 13          )
%   x5   ∈ [-10         , 3           ]   (range: 13          )
%   x6   ∈ [-1000000000 , 300000000   ]   (range: 1300000000  )
%   x7   ∈ [-1000000000 , 300000000   ]   (range: 1300000000  )
%   x8   ∈ [-1000000000 , 300000000   ]   (range: 1300000000  )
%   x9   ∈ [-1000000000 , 300000000   ]   (range: 1300000000  )
%   x10  ∈ [-1000000000 , 300000000   ]   (range: 1300000000  )
%
% Effective contrast ratio (max range / min range): 100000000
%
% Known global minimum (WORK-space):
%   x* = [1;1;1;1;1;100000000;100000000;100000000;100000000;100000000]
%   f* = 0
%
% USAGE:
...
lb_work = [-10;-10;-10;-10;-10;-1000000000;-1000000000;-1000000000;-1000000000;-1000000000];
ub_work = [3;3;3;3;3;300000000;300000000;300000000;300000000;300000000];
...
if nargin == 0
    ...
    info.x_global_min_work = [1;1;1;1;1;100000000;100000000;100000000;100000000;100000000];
