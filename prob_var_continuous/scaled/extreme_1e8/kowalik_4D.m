...
%   x3   ∈ [0           , 27300000    ]   (range: 27300000    )
%   x4   ∈ [0           , 27300000    ]   (range: 27300000    )
%
% Effective contrast ratio (max range / min range): 100000000
%
% Known global minimum (WORK-space):
%   x* = [0.192;0.19;12300000;13500000]
%   f* = 0.00030748
%
% USAGE:
...
lb_work = [0;0;0;0];
ub_work = [0.273;0.273;27300000;27300000];
...
if nargin == 0
    ...
    info.x_global_min_work = [0.192;0.19;12300000;13500000];
