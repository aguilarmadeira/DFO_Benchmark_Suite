...
%
%   x1   ∈ [-1.5        , 2.075       ]   (range: 3.575       )
%   x2   ∈ [-300000000  , 90000000    ]   (range: 390000000   )
%
% Effective contrast ratio (max range / min range): 100000000
%
% Known global minimum (WORK-space):
%   x* = [-0.5470000000000002;-154700000]
%   f* = -1.9133
%
% USAGE:
...
ub_work = [2.075;90000000.00000004];
...
if nargin == 0
    ...
    info.x_global_min_work = [-0.5470000000000002;-154700000];
