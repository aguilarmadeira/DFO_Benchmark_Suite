...
%   x4   ∈ [0           , 6.5         ]   (range: 6.5         )
%   x5   ∈ [0           , 6.5         ]   (range: 6.5         )
%   x6   ∈ [0           , 1950        ]   (range: 1950        )
%   x7   ∈ [0           , 1950        ]   (range: 1950        )
%   x8   ∈ [0           , 1950        ]   (range: 1950        )
%   x9   ∈ [0           , 1950        ]   (range: 1950        )
%   x10  ∈ [0           , 1950        ]   (range: 1950        )
%
...
ub_work = [6.5;6.5;6.5;6.5;6.5;1950;1950;1950;1950;1950];
