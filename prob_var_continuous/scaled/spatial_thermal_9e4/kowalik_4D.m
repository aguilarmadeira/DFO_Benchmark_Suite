...
%
%   x1   ∈ [0           , 0.273       ]   (range: 0.273       )
%   x2   ∈ [0           , 0.273       ]   (range: 0.273       )
%   x3   ∈ [0           , 81.9        ]   (range: 81.9        )
%   x4   ∈ [0           , 81.9        ]   (range: 81.9        )
%
% Effective contrast ratio (max range / min range): 300
%
% Known global minimum (WORK-space):
%   x* = [0.192;0.19;36.9;40.50000000000001]
%   f* = 0.00030748
%
% USAGE:
...
lb_work = [0;0;0;0];
ub_work = [0.273;0.273;81.90000000000001;81.90000000000001];
...
if nargin == 0
    ...
    info.x_global_min_work = [0.192;0.19;36.9;40.50000000000001];
