...
%   x4   ∈ [-100        , 30          ]   (range: 130         )
%   x5   ∈ [-100        , 30          ]   (range: 130         )
%   x6   ∈ [-30000      , 9000        ]   (range: 39000       )
%   x7   ∈ [-30000      , 9000        ]   (range: 39000       )
%   x8   ∈ [-30000      , 9000        ]   (range: 39000       )
%   x9   ∈ [-30000      , 9000        ]   (range: 39000       )
%   x10  ∈ [-30000      , 9000        ]   (range: 39000       )
%
% Effective contrast ratio (max range / min range): 300
%
% Known global minimum (WORK-space):
%   x* = [10;18;24;28;30;9000;8400;7200;5400;3000]
%   f* = -210
%
% USAGE:
...
ub_work = [30;30;30;30;30;9000;9000;9000;9000;9000];
...
if nargin == 0
    ...
    info.x_global_min_work = [10;18;24;28;30;9000;8400;7200;5400;3000];
