...
%
%   x1   ∈ [-338751633.852, 101625490.156]   (range: 440377124.008)
%   x2   ∈ [-7846.13361918, 2353.84008575]   (range: 10199.9737049)
%
% Effective contrast ratio (max range / min range): 43174.3391451
%
% Known global minimum (WORK-space):
%   x* = [5.960464477539062e-08;0]
%   f* = 0
%
% USAGE:
...
lb_orig = [-5;-5];
ub_orig = [1.5;1.5];
lb_work = [-338751633.8520584;-7846.133619177664];
ub_work = [101625490.1556175;2353.840085753299];
scale_factors = [67750326.77041167;1569.226723835533];
contrast_ratio = 43174.33914508866;
...
if nargin == 0
    ...
    info.x_global_min_work = [5.960464477539062e-08;0];
