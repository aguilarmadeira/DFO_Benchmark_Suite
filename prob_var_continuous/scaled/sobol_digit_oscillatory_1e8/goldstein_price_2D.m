...
%
%   x1   ∈ [-3655011.36607, 1096503.40982]   (range: 4751514.77589)
%   x2   ∈ [-157638929.294, 47291678.7883]   (range: 204930608.083)
%
% Effective contrast ratio (max range / min range): 43.1295318964
%
% Known global minimum (WORK-space):
%   x* = [0;-78819464.64723028]
%   f* = 3
%
% USAGE:
...
lb_work = [-3655011.366065699;-157638929.2944605];
ub_work = [1096503.40981971;47291678.78833816];
scale_factors = [1827505.68303285;78819464.64723027];
contrast_ratio = 43.12953189640696;
...
if nargin == 0
    ...
    info.x_global_min_work = [0;-78819464.64723028];
