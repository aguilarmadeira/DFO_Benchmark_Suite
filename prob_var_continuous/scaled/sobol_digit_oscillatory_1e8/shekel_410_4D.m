...
%
%   x1   ∈ [0           , 311880838.921]   (range: 311880838.921)
%   x2   ∈ [0           , 325130490.115]   (range: 325130490.115)
%   x3   ∈ [0           , 13309.6580386]   (range: 13309.6580386)
%   x4   ∈ [0           , 52494.4201404]   (range: 52494.4201404)
%
% Effective contrast ratio (max range / min range): 24428.1625548
%
% Known global minimum (WORK-space):
%   x* = [191926670.1052062;200080301.6090243;8190.558792962541;32304.25854793035]
%   f* = -10.5364
%
% USAGE:
...
nloc = 4;
lb_orig = [0;0;0;0];
ub_orig = [6.5;6.5;6.5;6.5];
lb_work = [0;0;0;0];
ub_work = [311880838.9209601;325130490.1146644;13309.65803856413;52494.42014038682];
scale_factors = [47981667.52630155;50020075.40225607;2047.639698240635;8076.064636982588];
contrast_ratio = 24428.16255478644;
...
if nargin == 0
    ...
    info.x_global_min_work = [191926670.1052062;200080301.6090243;8190.558792962541;32304.25854793035];
