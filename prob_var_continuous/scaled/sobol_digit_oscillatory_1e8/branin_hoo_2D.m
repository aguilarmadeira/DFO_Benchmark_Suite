...
%
%   x1   ∈ [-71216174.4802, 67655365.7562]   (range: 138871540.236)
%   x2   ∈ [0           , 95511.2159812]   (range: 95511.2159812)
%
% Effective contrast ratio (max range / min range): 1453.98149117
%
% USAGE:
...
lb_orig = [-5;0];
ub_orig = [4.75;9.75];
lb_work = [-71216174.48016325;0];
ub_work = [67655365.75615507;95511.21598124305];
scale_factors = [14243234.89603265;9796.022151922363];
contrast_ratio = 1453.981491174718;
