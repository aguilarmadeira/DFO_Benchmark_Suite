...
%
%   x1   ∈ [0           , 200953296.243]   (range: 200953296.243)
%   x2   ∈ [0           , 12775962.1771]   (range: 12775962.1771)
%
% Effective contrast ratio (max range / min range): 18.8748175793
%
% USAGE:
...
ub_orig = [3.25;3.9];
lb_work = [0;0];
ub_work = [200953296.2433455;12775962.17706406];
scale_factors = [61831783.45949092;3275887.737708733];
contrast_ratio = 18.8748175792917;
