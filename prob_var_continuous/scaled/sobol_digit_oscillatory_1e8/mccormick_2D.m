...
%
%   x1   ∈ [-91752503.2586, 126924296.174]   (range: 218676799.433)
%   x2   ∈ [-16243415.647, 4873024.6941]   (range: 21116440.3411)
%
% Effective contrast ratio (max range / min range): 11.2971933062
%
% Known global minimum (WORK-space):
%   x* = [-33459079.52164419;-8376188.001962236]
%   f* = -1.9133
%
% USAGE:
...
nloc = 2;
lb_orig = [-1.5;-3];
ub_orig = [2.075;0.9000000000000004];
lb_work = [-91752503.25862209;-16243415.64698559];
ub_work = [126924296.1744273;4873024.69409568];
scale_factors = [61168335.50574807;5414471.882328531];
contrast_ratio = 11.29719330621811;
...
if nargin == 0
    ...
    info.x_global_min_work = [-33459079.52164419;-8376188.001962236];
