...
%
%   x1   ∈ [-39232.7769115, 11769.8330735]   (range: 51002.609985)
%   x2   ∈ [-55033.9965319, 16510.1989596]   (range: 71544.1954914)
%
% Effective contrast ratio (max range / min range): 1.40275557491
%
% Known global minimum (WORK-space):
%   x* = [7.275957614183426e-12;7.275957614183426e-12]
%   f* = 0.9
%
% USAGE:
...
lb_orig = [-10;-10];
ub_orig = [3;3];
lb_work = [-39232.77691151039;-55033.99653185993];
ub_work = [11769.83307345312;16510.19895955798];
scale_factors = [3923.277691151038;5503.399653185993];
contrast_ratio = 1.402755574910979;
...
if nargin == 0
    ...
    info.x_global_min_work = [7.275957614183426e-12;7.275957614183426e-12];
