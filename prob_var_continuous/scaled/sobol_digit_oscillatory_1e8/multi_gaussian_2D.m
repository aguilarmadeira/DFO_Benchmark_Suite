...
%
%   x1   ∈ [-4844.55373113, 1453.36611934]   (range: 6297.91985047)
%   x2   ∈ [-184530190.719, 55359057.2158]   (range: 239889247.935)
%
% Effective contrast ratio (max range / min range): 38090.2351301
%
% Known global minimum (WORK-space):
%   x* = [-32.84607429704283;-1251114.693076134]
%   f* = -1.29695
%
% USAGE:
...
nloc = 2;
lb_orig = [-2;-2];
ub_orig = [0.6000000000000001;0.6000000000000001];
lb_work = [-4844.553731127327;-184530190.7191928];
ub_work = [1453.366119338198;55359057.21575785];
scale_factors = [2422.276865563663;92265095.3595964];
contrast_ratio = 38090.2351301309;
...
if nargin == 0
    ...
    info.x_global_min_work = [-32.84607429704283;-1251114.693076134];
