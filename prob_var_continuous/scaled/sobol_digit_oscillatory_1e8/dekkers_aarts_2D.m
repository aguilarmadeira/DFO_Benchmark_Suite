...
%
%   x1   ∈ [-516857872.546, 155057361.764]   (range: 671915234.309)
%   x2   ∈ [-1413129529.62, 423938858.887]   (range: 1837068388.51)
%
% Effective contrast ratio (max range / min range): 2.73407759596
%
% USAGE:
...
lb_orig = [-20;-20];
ub_orig = [6;6];
lb_work = [-516857872.5456613;-1413129529.623481];
ub_work = [155057361.7636984;423938858.8870443];
scale_factors = [25842893.62728307;70656476.48117404];
contrast_ratio = 2.734077595961623;
