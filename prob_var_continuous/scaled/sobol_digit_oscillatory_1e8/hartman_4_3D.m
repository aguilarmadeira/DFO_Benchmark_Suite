...
%
%   x1   ∈ [0           , 3138.0617132]   (range: 3138.0617132)
%   x2   ∈ [0           , 6193.75270204]   (range: 6193.75270204)
%   x3   ∈ [0           , 10739993.4025]   (range: 10739993.4025)
%
% Effective contrast ratio (max range / min range): 3422.49273087
%
% USAGE:
...
nloc = 3;
lb_orig = [0;0;0];
ub_orig = [0.65;0.65;0.65];
lb_work = [0;0;0];
ub_work = [3138.061713203019;6193.752702043249;10739993.40246408];
scale_factors = [4827.787251081568;9528.850310835767;16523066.77302165];
contrast_ratio = 3422.492730871684;
