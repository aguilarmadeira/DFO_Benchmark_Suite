...
%
%   x1   ∈ [-197232520.409, 59169756.1226]   (range: 256402276.531)
%   x2   ∈ [-506701621.407, 152010486.422]   (range: 658712107.83)
%
% Effective contrast ratio (max range / min range): 2.56905717352
%
% Known global minimum (WORK-space):
%   x* = [38521976.64229882;98965160.43113172]
%   f* = 0
%
% USAGE:
...
lb_orig = [-5.12;-5.12];
ub_orig = [1.536;1.536];
lb_work = [-197232520.4085699;-506701621.4073948];
ub_work = [59169756.12257099;152010486.4222185];
scale_factors = [38521976.6422988;98965160.43113178];
contrast_ratio = 2.569057173521665;
...
if nargin == 0
    ...
    info.x_global_min_work = [38521976.64229882;98965160.43113172];
