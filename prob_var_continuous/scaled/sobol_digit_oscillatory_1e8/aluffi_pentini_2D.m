...
%
%   x1   ∈ [-450254871.881, 135076461.564]   (range: 585331333.445)
%   x2   ∈ [-64486.5397685, 19345.9619305]   (range: 83832.501699)
%
% Effective contrast ratio (max range / min range): 6982.15276393
%
% Known global minimum (WORK-space):
%   x* = [-47119172.34233338;0]
%   f* = -0.3523
%
% USAGE:
...
lb_orig = [-10;-10];
ub_orig = [3;3];
lb_work = [-450254871.8808728;-64486.53976847314];
ub_work = [135076461.5642618;19345.96193054194];
scale_factors = [45025487.18808728;6448.653976847314];
contrast_ratio = 6982.152763932268;
...
if nargin == 0
    ...
    info.x_global_min_work = [-47119172.34233338;0];
