...
%   x2   ∈ [-51.2       , 15.36       ]   (range: 66.56       )
%   x3   ∈ [-512        , 153.6       ]   (range: 665.6       )
%   x4   ∈ [-5120       , 1536        ]   (range: 6656        )
%   x5   ∈ [-0.512      , 0.1536      ]   (range: 0.6656      )
%   x6   ∈ [-0.0512     , 0.01536     ]   (range: 0.06656     )
%   x7   ∈ [-0.00512    , 0.001536    ]   (range: 0.006656    )
%   x8   ∈ [-5.12       , 1.536       ]   (range: 6.656       )
%   x9   ∈ [-51.2       , 15.36       ]   (range: 66.56       )
%   x10  ∈ [-512        , 153.6       ]   (range: 665.6       )
%
% Effective contrast ratio (max range / min range): 1000000
%
% Known global minimum (WORK-space):
%   x* = [0;-7.105427357601002e-15;0;0;0;0;0;0;-7.105427357601002e-15;0]
%   f* = 0
%
% USAGE:
...
ub_work = [1.536;15.36;153.6;1536.000000000001;0.1536;0.01536000000000001;0.001536;1.536;15.36;153.6];
...
if nargin == 0
    ...
    info.x_global_min_work = [0;-7.105427357601002e-15;0;0;0;0;0;0;-7.105427357601002e-15;0];
