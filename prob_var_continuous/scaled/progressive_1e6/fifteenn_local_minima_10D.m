...
%   x1   ∈ [-10         , 3           ]   (range: 13          )
%   x2   ∈ [-100        , 30          ]   (range: 130         )
%   x3   ∈ [-1000       , 300         ]   (range: 1300        )
%   x4   ∈ [-10000      , 3000        ]   (range: 13000       )
%   x5   ∈ [-1          , 0.3         ]   (range: 1.3         )
%   x6   ∈ [-0.1        , 0.03        ]   (range: 0.13        )
%   x7   ∈ [-0.01       , 0.003       ]   (range: 0.013       )
%   x8   ∈ [-10         , 3           ]   (range: 13          )
%   x9   ∈ [-100        , 30          ]   (range: 130         )
%   x10  ∈ [-1000       , 300         ]   (range: 1300        )
%
% Effective contrast ratio (max range / min range): 1000000
%
% Known global minimum (WORK-space):
%   x* = [1;10;100;1000;0.1000000000000001;0.009999999999999995;0.001000000000000001;1;10;100]
%   f* = 0
%
% USAGE:
...
lb_work = [-10;-100;-1000;-10000;-1;-0.1;-0.01;-10;-100;-1000];
ub_work = [3;30;300;3000;0.3;0.03;0.003;3;30;300];
...
if nargin == 0
    ...
    info.x_global_min_work = [1;10;100;1000;0.1000000000000001;0.009999999999999995;0.001000000000000001;1;10;100];
