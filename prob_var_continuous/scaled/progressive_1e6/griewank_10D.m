...
%   x2   ∈ [-4000       , 1200        ]   (range: 5200        )
%   x3   ∈ [-40000      , 12000       ]   (range: 52000       )
%   x4   ∈ [-400000     , 120000      ]   (range: 520000      )
%   x5   ∈ [-40         , 12          ]   (range: 52          )
%   x6   ∈ [-4          , 1.2         ]   (range: 5.2         )
%   x7   ∈ [-0.4        , 0.12        ]   (range: 0.52        )
%   x8   ∈ [-400        , 120         ]   (range: 520         )
%   x9   ∈ [-4000       , 1200        ]   (range: 5200        )
%   x10  ∈ [-40000      , 12000       ]   (range: 52000       )
%
...
ub_work = [120;1200;12000;120000;12;1.2;0.12;120;1200;12000];
