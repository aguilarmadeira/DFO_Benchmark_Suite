...
%   x2   ∈ [-10         , 3           ]   (range: 13          )
%   x3   ∈ [-100        , 30          ]   (range: 130         )
%   x4   ∈ [-1000       , 300         ]   (range: 1300        )
%
% Effective contrast ratio (max range / min range): 1000
%
% Known global minimum (WORK-space):
%   x* = [0;0;-1.4210854715202e-14;-1.13686837721616e-13]
%   f* = -1
%
% USAGE:
...
lb_work = [-1;-10;-100;-1000];
ub_work = [0.3;3;30;300];
...
if nargin == 0
    ...
    info.x_global_min_work = [0;0;-1.4210854715202e-14;-1.13686837721616e-13];
