...
%   x1   ∈ [-30         , 9           ]   (range: 39          )
%   x2   ∈ [-300        , 90          ]   (range: 390         )
%   x3   ∈ [-3000       , 900         ]   (range: 3900        )
%   x4   ∈ [-30000      , 9000        ]   (range: 39000       )
%   x5   ∈ [-3          , 0.9         ]   (range: 3.9         )
%   x6   ∈ [-0.3        , 0.09        ]   (range: 0.39        )
%   x7   ∈ [-0.03       , 0.009       ]   (range: 0.039       )
%   x8   ∈ [-30         , 9           ]   (range: 39          )
%   x9   ∈ [-300        , 90          ]   (range: 390         )
%   x10  ∈ [-3000       , 900         ]   (range: 3900        )
%
% Effective contrast ratio (max range / min range): 1000000
%
% Known global minimum (WORK-space):
%   x* = [0;0;0;0;4.440892098500626e-16;5.551115123125783e-17;3.469446951953614e-18;0;0;0]
%   f* = 0
%
% USAGE:
...
lb_work = [-30;-300;-3000;-30000;-3;-0.3;-0.03;-30;-300;-3000];
ub_work = [9;90;900;9000;0.9000000000000001;0.09000000000000001;0.008999999999999999;9;90;900];
...
if nargin == 0
    ...
    info.x_global_min_work = [0;0;0;0;4.440892098500626e-16;5.551115123125783e-17;3.469446951953614e-18;0;0;0];
