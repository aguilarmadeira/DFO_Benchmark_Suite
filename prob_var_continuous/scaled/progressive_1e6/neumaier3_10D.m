...
%   x3   ∈ [-10000      , 3000        ]   (range: 13000       )
%   x4   ∈ [-100000     , 30000       ]   (range: 130000      )
%   x5   ∈ [-10         , 3           ]   (range: 13          )
%   x6   ∈ [-1          , 0.3         ]   (range: 1.3         )
%   x7   ∈ [-0.1        , 0.03        ]   (range: 0.13        )
%   x8   ∈ [-100        , 30          ]   (range: 130         )
%   x9   ∈ [-1000       , 300         ]   (range: 1300        )
%   x10  ∈ [-10000      , 3000        ]   (range: 13000       )
%
% Effective contrast ratio (max range / min range): 1000000
%
% Known global minimum (WORK-space):
%   x* = [10;180;2400;28000;3;0.3;0.028;24;180;1000]
%   f* = -210
%
% USAGE:
...
ub_work = [30;300;3000;30000;3;0.3;0.03;30;300;3000];
...
if nargin == 0
    ...
    info.x_global_min_work = [10;180;2400;28000;3;0.3;0.028;24;180;1000];
