...
%
%   x1   ∈ [-764360     , 229308      ]   (range: 993668      )
%   x2   ∈ [-3321.8     , 996.54      ]   (range: 4318.34     )
%   x3   ∈ [-2043080    , 612924      ]   (range: 2656004     )
%   x4   ∈ [-4600.52    , 1380.156    ]   (range: 5980.676    )
%   x5   ∈ [-444680     , 133404      ]   (range: 578084      )
%   x6   ∈ [-3002.12    , 900.636     ]   (range: 3902.756    )
%   x7   ∈ [-1723400    , 517020      ]   (range: 2240420     )
%   x8   ∈ [-4280.84    , 1284.252    ]   (range: 5565.092    )
%   x9   ∈ [-1084040    , 325212      ]   (range: 1409252     )
%   x10  ∈ [-3641.48    , 1092.444    ]   (range: 4733.924    )
%
% Effective contrast ratio (max range / min range): 680.545747672
%
% Known global minimum (WORK-space):
%   x* = [-1.164153218269348e-10;-4.547473508864641e-13;-2.328306436538696e-10;0;-5.820766091346741e-11;0;-2.328306436538696e-10;0;0;0]
%   f* = 0
%
% USAGE:
...
ub_work = [229308.0000000001;996.5400000000002;612924.0000000001;1380.156;133404;900.6360000000002;517020.0000000001;1284.252;325212.0000000002;1092.444];
...
if nargin == 0
    ...
    info.x_global_min_work = [-1.164153218269348e-10;-4.547473508864641e-13;-2.328306436538696e-10;0;-5.820766091346741e-11;0;-2.328306436538696e-10;0;0;0];
