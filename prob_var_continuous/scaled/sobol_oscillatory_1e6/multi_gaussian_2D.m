...
%
%   x1   ∈ [-298578.125 , 89573.4375  ]   (range: 388151.5625 )
%   x2   ∈ [-1297.578125, 389.2734375 ]   (range: 1686.8515625)
%
% Effective contrast ratio (max range / min range): 230.104160395
%
% Known global minimum (WORK-space):
%   x* = [-2024.359687500051;-8.797579687500047]
%   f* = -1.29695
%
% USAGE:
...
ub_work = [89573.4375;389.2734375000001];
...
if nargin == 0
    ...
    info.x_global_min_work = [-2024.359687500051;-8.797579687500047];
