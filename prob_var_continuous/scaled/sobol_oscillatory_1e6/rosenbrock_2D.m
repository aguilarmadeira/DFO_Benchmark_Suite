...
%   x* = [149289.0624999999;648.7890624999995]
%   f* = 0
%
% USAGE:
...
lb_orig = [-5.12;-5.12];
ub_orig = [1.536;1.536];
lb_work = [-764360;-3321.8];
ub_work = [229308.0000000001;996.5400000000002];
...
if nargin == 0
    ...
    info.x_global_min_work = [149289.0624999999;648.7890624999995];
