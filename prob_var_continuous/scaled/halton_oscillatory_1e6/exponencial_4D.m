...
%
%   x1   ∈ [-500500     , 150150      ]   (range: 650650      )
%   x2   ∈ [-250.75     , 75.225      ]   (range: 325.975     )
%   x3   ∈ [-750250     , 225075      ]   (range: 975325      )
%   x4   ∈ [-125.875    , 37.7625     ]   (range: 163.6375    )
%
% Effective contrast ratio (max range / min range): 5960.27805362
%
% Known global minimum (WORK-space):
%   x* = [-5.820766091346741e-11;0;-1.164153218269348e-10;0]
%   f* = -1
%
% USAGE:
...
lb_work = [-500500;-250.75;-750250;-125.875];
ub_work = [150150;75.22500000000002;225075;37.76250000000001];
...
if nargin == 0
    ...
    info.x_global_min_work = [-5.820766091346741e-11;0;-1.164153218269348e-10;0];
