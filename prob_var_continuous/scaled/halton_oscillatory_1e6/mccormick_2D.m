...
%
%   x1   ∈ [-750750     , 1038537.5   ]   (range: 1789287.5   )
%   x2   ∈ [-752.25     , 225.675     ]   (range: 977.925     )
%
% Effective contrast ratio (max range / min range): 1996.01196411
%
% Known global minimum (WORK-space):
%   x* = [-273773.5000000001;-387.91025]
%   f* = -1.9133
%
% USAGE:
...
ub_work = [1038537.5;225.6750000000001];
...
if nargin == 0
    ...
    info.x_global_min_work = [-273773.5000000001;-387.91025];
