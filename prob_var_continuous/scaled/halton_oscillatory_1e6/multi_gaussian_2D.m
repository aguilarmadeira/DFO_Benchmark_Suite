...
%
%   x1   ∈ [-1001000    , 300300      ]   (range: 1301300     )
%   x2   ∈ [-501.5      , 150.45      ]   (range: 651.95      )
%
% Effective contrast ratio (max range / min range): 1996.01196411
%
% Known global minimum (WORK-space):
%   x* = [-6786.780000000144;-3.400170000000003]
%   f* = -1.29695
%
% USAGE:
...
if nargin == 0
    ...
    info.x_global_min_work = [-6786.780000000144;-3.400170000000003];
