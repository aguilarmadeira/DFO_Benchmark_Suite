...
%   x2   ∈ [0           , 1           ]   (range: 1           )
%   x3   ∈ [0           , 1           ]   (range: 1           )
%   x4   ∈ [0           , 100000000   ]   (range: 100000000   )
%   x5   ∈ [0           , 100000000   ]   (range: 100000000   )
%   x6   ∈ [0           , 100000000   ]   (range: 100000000   )
%
% Effective contrast ratio (max range / min range): 100000000
%
% Known global minimum (WORK-space):
%   x* = [0.20169;0.150011;0.476874;27533200;31165200;65730000]
%   f* = -3.32237
%
% USAGE:
...
ub_orig = [1;1;1;1;1;1];
lb_work = [0;0;0;0;0;0];
ub_work = [1;1;1;100000000;100000000;100000000];
...
if nargin == 0
    ...
    info.x_global_min_work = [0.20169;0.150011;0.476874;27533200;31165200;65730000];
