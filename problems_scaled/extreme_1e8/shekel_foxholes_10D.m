...
%   x4   ∈ [0           , 10          ]   (range: 10          )
%   x5   ∈ [0           , 10          ]   (range: 10          )
%   x6   ∈ [0           , 1000000000  ]   (range: 1000000000  )
%   x7   ∈ [0           , 1000000000  ]   (range: 1000000000  )
%   x8   ∈ [0           , 1000000000  ]   (range: 1000000000  )
%   x9   ∈ [0           , 1000000000  ]   (range: 1000000000  )
%   x10  ∈ [0           , 1000000000  ]   (range: 1000000000  )
%
% Effective contrast ratio (max range / min range): 100000000
%
% Known global minimum (WORK-space):
%   x* = [8.025;9.151999999999999;5.114;7.621;4.564;471100000;299600000;612600000;73400000;498200000.0000001]
%   f* = -10.2087915119
%
% USAGE:
...
if nargin == 0
    ...
    info.x_global_min_work = [8.025;9.151999999999999;5.114;7.621;4.564;471100000;299600000;612600000;73400000;498200000.0000001];
