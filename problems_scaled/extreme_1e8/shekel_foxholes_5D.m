...
%   x1   ∈ [0           , 10          ]   (range: 10          )
%   x2   ∈ [0           , 10          ]   (range: 10          )
%   x3   ∈ [0           , 1000000000  ]   (range: 1000000000  )
%   x4   ∈ [0           , 1000000000  ]   (range: 1000000000  )
%   x5   ∈ [0           , 1000000000  ]   (range: 1000000000  )
%
% Effective contrast ratio (max range / min range): 100000000
%
% Known global minimum (WORK-space):
%   x* = [8.025;9.151999999999999;511399999.9999999;762100000;456400000]
%   f* = -10.4056057586
%
% USAGE:
...
lb_work = [0;0;0;0;0];
ub_work = [10;10;1000000000;1000000000;1000000000];
scale_factors = [1;1;100000000;100000000;100000000];
...
if nargin == 0
    ...
    info.x_global_min_work = [8.025;9.151999999999999;511399999.9999999;762100000;456400000];
