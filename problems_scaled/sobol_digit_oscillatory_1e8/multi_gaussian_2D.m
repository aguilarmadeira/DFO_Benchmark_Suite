...
% Effective contrast: 2.279198453008708
%
...
lb_orig = [-2;-2];
ub_orig = [2;2];
lb_work = [-12158.55309095191;-5334.574124031074];
ub_work = [12158.55309095191;5334.574124031074];
scale_factors = [6079.276545475953;2667.287062015537];
contrast_ratio = 2.279198453008708;
...
if nargin == 0
    ...
    info.x_global_min_work = [-82.43498995665323;-36.16841256093085];
