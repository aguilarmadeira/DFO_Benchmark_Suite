...
%   x4   ∈ [-10         , 10          ]   (range: 20          )
%   x5   ∈ [-10         , 10          ]   (range: 20          )
%   x6   ∈ [-3000       , 3000        ]   (range: 6000        )
%   x7   ∈ [-3000       , 3000        ]   (range: 6000        )
%   x8   ∈ [-3000       , 3000        ]   (range: 6000        )
%   x9   ∈ [-3000       , 3000        ]   (range: 6000        )
%   x10  ∈ [-3000       , 3000        ]   (range: 6000        )
%
% Effective contrast ratio (max range / min range): 300
%
% Known global minimum (WORK-space):
%   x* = [1;1;1;1;1;300.0000000000005;300.0000000000005;300.0000000000005;300.0000000000005;300.0000000000005]
%   f* = 0
%
% USAGE:
...
lb_work = [-10;-10;-10;-10;-10;-3000;-3000;-3000;-3000;-3000];
ub_work = [10;10;10;10;10;3000;3000;3000;3000;3000];
...
if nargin == 0
    ...
    info.x_global_min_work = [1;1;1;1;1;300.0000000000005;300.0000000000005;300.0000000000005;300.0000000000005;300.0000000000005];
