...
%   x4   ∈ [-30         , 30          ]   (range: 60          )
%   x5   ∈ [-30         , 30          ]   (range: 60          )
%   x6   ∈ [-9000       , 9000        ]   (range: 18000       )
%   x7   ∈ [-9000       , 9000        ]   (range: 18000       )
%   x8   ∈ [-9000       , 9000        ]   (range: 18000       )
%   x9   ∈ [-9000       , 9000        ]   (range: 18000       )
%   x10  ∈ [-9000       , 9000        ]   (range: 18000       )
%
...
lb_work = [-30;-30;-30;-30;-30;-9000;-9000;-9000;-9000;-9000];
