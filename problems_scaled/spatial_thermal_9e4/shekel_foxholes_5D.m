...
%   x1   ∈ [0           , 10          ]   (range: 10          )
%   x2   ∈ [0           , 10          ]   (range: 10          )
%   x3   ∈ [0           , 3000        ]   (range: 3000        )
%   x4   ∈ [0           , 3000        ]   (range: 3000        )
%   x5   ∈ [0           , 3000        ]   (range: 3000        )
%
% Effective contrast ratio (max range / min range): 300
%
% Known global minimum (WORK-space):
%   x* = [8.025;9.151999999999999;1534.2;2286.3;1369.2]
%   f* = -10.4056057586
%
% USAGE:
...
if nargin == 0
    ...
    info.x_global_min_work = [8.025;9.151999999999999;1534.2;2286.3;1369.2];
