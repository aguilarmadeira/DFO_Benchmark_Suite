...
%   x4   ∈ [0           , 10          ]   (range: 10          )
%   x5   ∈ [0           , 10          ]   (range: 10          )
%   x6   ∈ [0           , 3000        ]   (range: 3000        )
%   x7   ∈ [0           , 3000        ]   (range: 3000        )
%   x8   ∈ [0           , 3000        ]   (range: 3000        )
%   x9   ∈ [0           , 3000        ]   (range: 3000        )
%   x10  ∈ [0           , 3000        ]   (range: 3000        )
%
% Effective contrast ratio (max range / min range): 300
%
% Known global minimum (WORK-space):
%   x* = [8.074;8.776999999999999;3.467;1.867;6.708;1904.7;1360.2;82.80000000000001;2289.9;470.1]
%   f* = -0.965
%
% USAGE:
...
if nargin == 0
    ...
    info.x_global_min_work = [8.074;8.776999999999999;3.467;1.867;6.708;1904.7;1360.2;82.80000000000001;2289.9;470.1];
