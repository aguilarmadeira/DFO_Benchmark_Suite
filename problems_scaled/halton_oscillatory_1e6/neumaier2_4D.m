...
%
%   x1   ∈ [0           , 2002000     ]   (range: 2002000     )
%   x2   ∈ [0           , 1003        ]   (range: 1003        )
%   x3   ∈ [0           , 3001000     ]   (range: 3001000     )
%   x4   ∈ [0           , 503.5       ]   (range: 503.5       )
%
% Effective contrast ratio (max range / min range): 5960.27805362
%
% Known global minimum (WORK-space):
%   x* = [500500;501.5;1500500;377.625]
%   f* = 0
%
% USAGE:
...
if nargin == 0
    ...
    info.x_global_min_work = [500500;501.5;1500500;377.625];
