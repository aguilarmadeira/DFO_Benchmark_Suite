...
%
%   x1   ∈ [0           , 746445.3125 ]   (range: 746445.3125 )
%   x2   ∈ [0           , 3892.734375 ]   (range: 3892.734375 )
%
% Effective contrast ratio (max range / min range): 230.104160395
%
% Known global minimum (WORK-space):
%   x* = [597156.25;1297.578125]
%   f* = -2.3458
%
% USAGE:
...
ub_orig = [5;6];
lb_work = [0;0];
ub_work = [746445.3125;3892.734375];
...
if nargin == 0
    ...
    info.x_global_min_work = [597156.25;1297.578125];
